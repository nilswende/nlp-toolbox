...
public class Cooccs {
	...
	public double getPositionDistance(Vector pos1, Vector pos2) {
		...
		} else if (termstart_pos1.equals(termstart_pos2) && termend_pos1.equals(termend_pos2)) {
		...
		} else if (termstart_pos1.equals(termend_pos2) && termend_pos1.equals(termstart_pos2)) {
			//this case should not occur for the evolving centroid calculations
					...
					while (term1iterator.hasNext()) {
						...
						if (!query.contains(term1str)) {
							...
							if (curnumberofaddedpaths != 0) {
								...
								} else if (maximumaddedpaths < curnumberofaddedpaths) {
