...
public class Parameters {
	 ...
	 *
	 * @param lang an integer constant (appropiate constants are defined in the
	 *             Parameters class)
	 */
	 ...
	 *
	 * @param tagg an integer constant (appropriate constants are defined in the
	 *             Parameters class)
	 */
	 ...
	 *
	 * @param mf the frequency threshold
	 */
	 ...
	 *
	 * @param ms the significance threshold
	 */
	 ...
	 *
	 * @param cmf the corpus freq. threshold
	 */
	 ...
	 *
	 * @param ra the access mode to be set (appropiate constants are defined in
	 ...
	 *
	 * @param sf an integer constant for the sig measure to use. (appropiate
	 ...
	 *
	 * @param mfm an integer describing the threshold
	 */
	 ...
	 *
	 * @param mfc an integer describing the threshold
	 */
	 ...
	 *
	 * @param mfp an integer describing the threshold
	 */
	 ...
	 *
	 * @param patterns a List of Strings describing the patterns to search for
	 */
	 ...
	 *
	 * @param s a boolean indicating whether stemming should be performed or
	 *          not
	 */
	 ...
	 *
	 * @param f a boolean indicating whether sigs should be calculated also
	 ...
	 *
	 * @param r a boolean indicating whether sig values of unknown words
	 *          should be rescaled
	 */
