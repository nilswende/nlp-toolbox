...
class CentroidBySpreadingActivationTest {
	...
	private static HashMap<String, Map<String, Double>> mutable(final Map<String, Map<String, Double>> immutable) {
		final var mutable = new HashMap<>(immutable);
		mutable.replaceAll((k, v) -> new HashMap<>(v));
		return mutable;
	}
